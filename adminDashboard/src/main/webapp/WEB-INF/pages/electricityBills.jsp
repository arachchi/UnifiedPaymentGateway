...
<html lang="en">
<head>
    <jsp:include page="/includes/transactionContents/head.jsp"></jsp:include>
</head>
<body>
<div id="wrapper">
    ...
    <nav class="navbar-side" role="navigation">
      <div class="navbar-collapse sidebar-collapse collapse">
        ...
        <ul id="side" class="nav navbar-nav side-nav">
          ...
          <li>
            <a class="active" href="electricityBills">
...
<script src="${pageContext.request.contextPath}/assets/js/electricityBill/electricityBill.js"></script>
</body>
</html>
